...
alias gl1='gl -1'
alias gl='g log --graph --boundary --pretty=format:"%Cred%h%Creset - %s%C(yellow)%d%Creset %Cgreen(%aD) %C(bold blue)<%an>%Creset"' # author date
# alias gl='g log --graph --boundary --pretty=format:"%Cred%h%Creset - %s%C(yellow)%d%Creset %Cgreen(%cD) %C(bold blue)<%an>%Creset"' # commiter date
